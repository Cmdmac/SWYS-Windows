...
HELP_TEXT = (
    ...
    "截图 / 锁屏 / 关机 / 重启 / 睡眠\n"
    "音量调大 / 音量调小 / 静音\n"
    "最小化窗口 / 最大化窗口 / 还原窗口 / 关闭窗口（作用最顶层可见窗口，不会关掉本程序）/ 回到桌面 / 切换窗口（上一个窗口 / 下一个窗口）\n"
    "向上一级 / 返回（后退）/ 前进  （文件管理器导航，作用最顶层可见窗口）\n"
    "进入 工作 / 进入目录 工作（双击文件管理器中同名文件夹）/ 进入 D:\\work（按路径打开）\n"
    "窗口  /  当前窗口  （在鼠标当前位置点击该窗口）\n"
    "点击窗口菜单  /  双击  /  右击  /  点击 100,200  /  鼠标移到 100,200  /  向上滚动  /  向下滚动\n"
    "输入 你好世界  /  现在几点 / 今天星期几\n"
    "\n"
    "【可见可说：说出控件/菜单名即控制】\n"
